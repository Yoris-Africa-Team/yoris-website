      ...
      <Box style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        <Box sx={{ borderRadius: "15px" }}>
          <Accordion sx={{ backgroundColor: "#fffefc" }}>
            ...
            >
              <AccordionHeaderText>
                Do businesses really get free websites and apps?
              </AccordionHeaderText>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Sed velit proin nibh fames facilisi semper. Condimentum enim
                risus commodo ipsum. Semper ac gravida nascetur et malesuada. At
                cras elit.
              </Typography>
            </AccordionDetails>
          </Accordion>
        ...
        <Box sx={{ borderRadius: "15px", overflow: "hidden" }}>
          <Accordion sx={{ backgroundColor: "#fffefc" }}>
            ...
            >
              <AccordionHeaderText>
                Is it true i can ship for as low as 300 Naira?
              </AccordionHeaderText>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
        ...
        <Box sx={{ borderRadius: "15px", overflow: "hidden" }}>
          <Accordion sx={{ backgroundColor: "#fffefc" }}>
            ...
            >
              <AccordionHeaderText>
                Where is your delivery coverage ?
              </AccordionHeaderText>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
      ...
      <Box style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        ...
        <Box sx={{ borderRadius: "15px", overflow: "hidden" }}>
          <Accordion sx={{ backgroundColor: "#fffefc" }}>
            ...
            >
              <AccordionHeaderText>
                Is it true i can be a female rider?
              </AccordionHeaderText>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
